...
def main(self=None):
    ...
    #create_team_menu = Menu(screen, "menu/menu_jsons/create_team_menu.json", background_image)
    #new_team_menu = Menu(screen, "menu/menu_jsons/new_team.json", background_image)
    #pause_menu = Menu(screen, "menu/menu_jsons/pause_menu.json", background_image)
    ...
    """if self.current_state_output[0]['menu_item_data'] == "Main Menu":
            ...
            create_franchise_menu = Menu(screen, "menu/menu_jsons/create_franchise_menu.json", background_image)
